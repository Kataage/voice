...
from personavoice.speaker import cosine_similarity, dominant_speaker, overlap_ratio, select_target_speaker
...
def test_speaker_math():
    ...
    label, score = select_target_speaker(
        {"A": [1.0, 0.0], "B": [0.0, 1.0]}, [[0.95, 0.05]], threshold=0.5
    )
...
def test_dataset_roundtrip(tmp_path: Path):
    ...
    row = {
        "id": "x", "source_id": "s", "start": 0.0, "end": 2.0, "speaker": "A",
        "target": True, "speaker_similarity": 0.9, "speaker_coverage": 1.0,
        "overlap_ratio": 0.0, "text": "こんにちは", "text_annotated": "こんにちは",
        "emotion": "NEUTRAL", "events": [], "caption": "自然に話している。",
        "audio_path": None, "quality": 0.9,
    }
