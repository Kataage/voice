...
def test_irodori_v41_uses_its_own_huggingface_revision() -> None:
    assert IRODORI_MODEL_ID == "Aratako/Irodori-TTS-v4.1-Small"
    assert IRODORI_MODEL_REVISION == V41_MODEL_REVISION
    assert IRODORI_MODEL_REVISION != V4_MODEL_REVISION
    assert IRODORI_MODEL_SHA256 == V41_MODEL_SHA256
